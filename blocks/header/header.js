...
/**
 * Applies nav enhancements after the block has been fully rendered.
 * Merged from block-config.js afterDecorate.
 * @param {Element} block - The header block element.
 */
function applyNavEnhancements(block) {
